...
int ***getTrainingSet(int noPeople,int k, int histoSize, int rowcount, int columncount, char* baseFolder,double *seq, double *para){
...
int ***getTestSets(int noPeople,int k, int histoSize, int rowcount, int columncount, char* baseFolder,double *seq, double *para){
